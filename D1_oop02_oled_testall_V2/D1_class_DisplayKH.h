//_____D1_class_DisplayKH.h___________________170412-171218_____
...
#define DOT         String((char)248)  // . 248 or 46
...
class DisplayKH : public Adafruit_SSD1306 {
 ...
 void screen4ii(int line_,String text_);
 void screen4ii(int line_,String text_, char align_);
 void screen4iiClear(int line_,String text_, char align_);
...
const uint8_t fontKH_5x8Bitmaps[] PROGMEM = {
 ...
 0x00, 0x00, 0x63, 0x00, 0x00, // 0xF8 = 248 '�' //'�' 0 0 40 0 0
